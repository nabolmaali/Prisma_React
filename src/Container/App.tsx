...
import { AccessDenied, AllOrders, AuthenticationAdminTest, AuthenticationTest, Home, Login, MenuItemDetails, MenuItemList, MenuItemUpsert, MyOrders, NotFound, OrderConfirmed, OrderDetails, Payment, Register, ShoppingCart } from '../Pages';
